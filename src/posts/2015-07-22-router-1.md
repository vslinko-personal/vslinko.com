...
I could do it like in most of big routers - write a standard for route definitions,
accept array of routes, implement matching algorithm, or I could provide to a user
a lot of abstract classes like Route, RouteCollection, RouteMatchingStrategy, etc.
All these variants makes code and API more complicated and gives less freedom to
configuration. My goal is opposite - I want to make it all simple as possible
and functional paradigm helps me with that.

> Providing a single function into router releases it from requirement to
> implement different algorithms. For the router that function is fully prepared
